...
<li class="mt-0.5 w-full">
    <a href="{{ $href }}" class="{{ request()->is(ltrim($href, '/')) ? 'rounded-lg bg-secondaryRed/13 font-semibold text-red-700' : 'ease ' }} hover:bg-primaryRed/5 rounded-lg mx-2 my-0 flex items-center whitespace-nowrap px-4 py-2.7 text-base transition-colors">
