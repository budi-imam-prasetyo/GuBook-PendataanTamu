                    ...
                    <ul id="dropdown-menu" class="hidden flex-col space-y-2 py-2 pl-14 transition-all">
                        <li>
                            <a href="/admin/laporan-tamu"
                                class="{{ request()->is('admin/laporan-tamu') ? 'rounded-lg bg-secondaryBlue/13 font-semibold text-primaryBlue' : 'ease' }} block text-sm px-4 py-2 text-slate-700 hover:bg-primaryBlue/5 hover:text-primaryBlue  rounded-md select-none transition-all">Laporan
                                Tamu</a>
                        </li>
                        <li>
                            <a href="/admin/laporan-kurir"
                                class="{{ request()->is('admin/laporan-kurir') ? 'rounded-lg bg-secondaryBlue/13 font-semibold text-primaryBlue' : 'ease' }} block text-sm px-4 py-2 text-slate-700 hover:bg-primaryBlue/5 hover:text-primaryBlue  rounded-md select-none transition-all">Laporan
                                Kurir</a>
                        </li>
                    </ul>
                </li>
