...
<body
    class="no-scrollbar m-0 bg-gray-50 font-sans text-base font-medium leading-default text-slate-500 antialiased dark:bg-slate-900">
    @apexchartsScripts
    ...
    <main class="relative h-full max-h-screen rounded-xl transition-all duration-200 ease-in-out xl:ml-68">
                        ...
                        <div class="flex-auto px-4 py-6">
                            <div class="-mx-1 flex flex-row justify-between">
                                ...
                                <div class="px-3 text-right">
                                    <div
                                        class="flex h-16 w-16 items-center justify-center rounded-circle bg-gradient-to-tl from-blue-500 to-violet-500">
                        ...
                        <div class="flex-auto p-4">
                            <div class="-mx-3 flex flex-row items-center justify-center">
                                ...
                                <div class="basis-1/3 px-3 text-center">
                                    <div
                                        class="mx-auto flex h-20 w-20 items-center justify-center rounded-circle bg-gradient-to-tl from-red-600 to-orange-600">
                                ...
                                <div class="w-1/3 max-w-full flex-none px-3">
                                    <p
                                        class="mb-0 text-right font-sans text-lg font-semibold leading-normal dark:text-white dark:opacity-60">
                                        Kunjungan Bulan Ini
                                    </p>
                                    <h5 class="mb-2 text-right font-bold dark:text-white">
                                        541
                                    </h5>
                                </div>
                            </div>
                        ...
                        <div class="flex-auto px-4 py-6">
                            <div class="-mx-3 flex flex-row justify-between">
                                <div class="pl-6 text-left">
                                    <div
                                        class="flex h-16 w-16 items-center justify-center rounded-circle bg-gradient-to-tl from-orange-500 to-yellow-500">
                            ...
                            <li
                                ...
                                <div class="ml-4 flex gap-7">
                                    ...
                                    <div class="flex flex-col">
                                        <h5 class="text-lg">Oliver Liam</h5>
                                        <div class="ml-1 flex gap-2">
                                            <div class="flex flex-col gap-3">
                                                <img src="{{ asset('assets/icons/arrow-left.svg') }}" class="w-5"
                                                    alt="arrow" />
                                                <img src="{{ asset('assets/icons/mail.svg') }}" class="w-5"
                                                    alt="mail" />
                                                <img src="{{ asset('assets/icons/time.svg') }}" class="w-5"
                                                    alt="time" />
                                            </div>
                                            <div class="mb-2 flex flex-col gap-3 text-sm leading-tight">
                                ...
                                <div class="ml-auto flex items-center text-right">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <div class="ml-1 flex gap-2">
                                            <div class="flex flex-col gap-3">
                                                <img src="{{ asset('assets/icons/arrow-left.svg') }}" class="w-5"
                                                    alt="arrow" />
                                                <img src="{{ asset('assets/icons/truck2.svg') }}" class="w-5"
                                                    alt="truck" />
                                                <img src="{{ asset('assets/icons/time.svg') }}" class="w-5"
                                                    alt="time" />
                                            </div>
        ...
        <footer class="py-4 text-center dark:bg-gray-800">
            <p class="text-sm text-gray-600 dark:text-gray-400">
                &copy;
                <script>
                    document.write(new Date().getFullYear());
                </script>
                <span class="text-primaryBlue">GuBook</span>
                , dibuat dengan
