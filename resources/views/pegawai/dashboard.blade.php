                        ...
                        <div class="mb-0 rounded-2xl border-b-0 border-solid border-dark/12.5 p-6 pb-0 pt-4">
                            ...
                            <p class="mb-0 text-sm leading-normal dark:text-white dark:opacity-60">
                                <span class="font-semibold">
                                    @if ($statistik > 0)
                                        <span class="text-green-500 text-base">+{{ abs($statistik) }} Kunjungan</span>
                                    @elseif ($statistik < 0)
                                        <span class="text-red-500 text-base">-{{ abs($statistik) }} Kunjungan</span>
                                    @else
                                        <span class="text-orange-500 text-base">Tidak Ada Kenaikan Kunjungan</span>
                                    @endif
                                </span>
