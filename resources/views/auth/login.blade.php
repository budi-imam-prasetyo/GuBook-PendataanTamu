...
@section('content')
    <div class="grid grid-cols-2 h-screen">
        ...
        <div class="relative bg-primaryBlue xl:bg-transparent flex justify-start">
            <img src="{{ asset('assets/bg-login2.svg') }}" class="w-full hidden xl:block object-cover absolute h-screen" alt="">
            ...
            <div class="absolute bottom-0"><img src="{{ asset('assets/wave.svg') }}" class="mix-blend-lighten md:block hidden -translate-x-20 object-cover" alt=""></div>
        </div>
            ...
            <div class="w-full max-w-2xl">
                <div class="px-8 flex flex-col pt-6 pb-8 mb-4">
                    ...
                    <div class="m-10 flex h-full flex-col mt-80">
                        <form method="POST" action="{{ route('login') }}" class="mx-auto w-full max-w-full gap-10 flex flex-col">
                            @csrf
                            ...
                            <div class="mb-4 w-full" x-data="{ show: true }">
                                <div class="relative">
                                    <input autocomplete="off" id="password" name="password" :type="show ? 'password' : 'text'"
                                        class="peer placeholder-transparent focus:placeholder:text-grey h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-dark"
